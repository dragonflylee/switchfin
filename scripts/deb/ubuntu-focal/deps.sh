...
wget -qO- https://downloads.videolan.org/pub/videolan/dav1d/1.4.0/dav1d-1.4.0.tar.xz | tar Jxf - -C /tmp
...
./configure --prefix=$CMAKE_PREFIX_PATH --enable-shared --disable-static \
  ...
  --enable-libdav1d --enable-demuxer=hls --disable-muxers --disable-avdevice \
